...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    while cap.isOpened():
        ...
        try:
            ...
            visibility = landmarks[mp_pose.PoseLandmark.LEFT_PINKY.value].visibility
            if visibility>0.6:
                # Visualize
                ...
                if shoulder[1]< PREV_COORDINATE-0.04 and STAGE == "down":
                    STAGE = "up"
                    #print("up")          
                if shoulder[1]> PREV_COORDINATE+0.04 and STAGE == "up":
                    STAGE = "down"
                    COUNTER +=1
                    #print("down")
                    #if counter % 100 == 0:
